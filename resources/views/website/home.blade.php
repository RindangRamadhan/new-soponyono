...
<body>
 <!-- Header -->
  ...
  <header class="h-[75px] w-full bg-[#12191C] px-6 xl:px-0">
        ...
        >
          <img src="/images/website/logo.png" alt="Logo" class="w-[50px] h-auto" />
      ...
      <section
        id="home"
        class="h-full lg:h-[calc(100vh_-_75px)] w-full bg-[url('/images/website/background_hero.png')] bg-cover relative"
      >
        <img
          src="/images/website/bg_overlay.png"
        ...
        >
          ...
          >
            ...
            >
              <img
                src="/images/website/hero_background.png"
                alt="background hero"
      ...
      >
        ...
        >
          ...
          <div class="lg:basis-6/12 relative hidden lg:block">
            <img
              src="/images/website/about-us/image_1.png"
              alt="About us one"
              class="absolute left-1/2 -translate-x-1/2 w-[235px] h-[300px]"
            />
            <img
              src="/images/website/about-us/image_2.png"
              alt="About us one"
              class="absolute right-[0px] w-[235px] h-[200px] top-6"
            />
            <img
              src="/images/website/about-us/image_3.png"
              alt="About us one"
      ...
      <section id="service" class="w-full bg-white py-16">
        <div class="max-w-[1100px] mx-auto flex flex-col gap-10 px-6 lg:px-0">
          ...
          <div class="grid grid-cols-12 gap-5">
            <div
              class="relative col-span-12 md:col-span-6 lg:col-span-4 rounded-[20px] bg-[url('/images/website/service/wedding.png')] w-full h-[200px] bg-cover"
            >
              <div
            ...
            <div
              class="relative col-span-12 md:col-span-6 lg:col-span-4 rounded-[20px] bg-[url('/images/website/service/akad.png')] w-full h-[200px] bg-cover"
            >
              <div
                class="absolute rounded-tr-[32.97px] rounded-bl-[20px] bottom-0 left-0 bg-black flex items-center justify-center text-white text-lg px-6 py-2 font-semibold"
              >
            ...
            <div
              class="relative col-span-12 md:col-span-6 lg:col-span-4 rounded-[20px] bg-[url('/images/website/service/lamaran.png')] w-full h-[200px] bg-cover"
            >
              <div
                class="absolute rounded-tr-[32.97px] rounded-bl-[20px] bottom-0 left-0 bg-black flex items-center justify-center text-white text-lg px-6 py-2 font-semibold"
              >
            ...
            <div
              class="relative col-span-12 md:col-span-6 lg:col-span-4 rounded-[20px] bg-[url('/images/website/service/khitan.png')] w-full h-[200px] bg-cover"
            >
              <div
                class="absolute rounded-tr-[32.97px] rounded-bl-[20px] bottom-0 left-0 bg-black flex items-center justify-center text-white text-lg px-6 py-2 font-semibold"
              >
            ...
            <div
              class="relative col-span-12 md:col-span-6 lg:col-span-4 rounded-[20px] bg-[url('/images/website/service/cathering.png')] w-full h-[200px] bg-cover"
            >
              <div
                class="absolute rounded-tr-[32.97px] rounded-bl-[20px] bottom-0 left-0 bg-black flex items-center justify-center text-white text-lg px-6 py-2 font-semibold"
              >
            ...
            <div
              class="relative col-span-12 md:col-span-6 lg:col-span-4 rounded-[20px] bg-[url('/images/website/service/tenda_dekorasi.png')] w-full h-[200px] bg-cover"
            >
              <div
                class="absolute rounded-tr-[32.97px] rounded-bl-[20px] bottom-0 left-0 bg-black flex items-center justify-center text-white text-lg px-6 py-2 font-semibold"
              >
            ...
            <div
              class="relative col-span-12 md:col-span-6 lg:col-span-4 rounded-[20px] bg-[url('/images/website/service/entertaiment.png')] w-full h-[200px] bg-cover"
            >
              <div
                class="absolute rounded-tr-[32.97px] rounded-bl-[20px] bottom-0 left-0 bg-black flex items-center justify-center text-white text-lg px-6 py-2 font-semibold"
              >
            ...
            <div
              class="relative col-span-12 md:col-span-6 lg:col-span-4 rounded-[20px] bg-[url('/images/website/service/mua.png')] w-full h-[200px] bg-cover"
            >
              <div
                class="absolute rounded-tr-[32.97px] rounded-bl-[20px] bottom-0 left-0 bg-black flex items-center justify-center text-white text-lg px-6 py-2 font-semibold"
              >
            ...
            <div
              class="relative col-span-12 md:col-span-6 lg:col-span-4 rounded-[20px] bg-[url('/images/website/service/dokumentasi.png')] w-full h-[200px] bg-cover"
            >
              <div
                class="absolute rounded-tr-[32.97px] rounded-bl-[20px] bottom-0 left-0 bg-black flex items-center justify-center text-white text-lg px-6 py-2 font-semibold"
              >
      ...
      <section
        id="weddingpackage"
        class="w-full bg-[#181818] min-h-[500px] bg-[url('/images/website/wedding-package/bg_wedding_package.png')] bg-cover"
      >
        <div
          class="relative max-w-[1100px] mx-auto flex lg:justify-end px-6 lg:px-0"
        >
          <img
            src="/images/website/wedding-package/shape_wedding_package.png"
      ...
      <section id="gallery" class="w-full bg-white py-16">
        <div class="max-w-[1100px] mx-auto flex flex-col gap-10 px-6 lg:px-0">
          ...
          <div class="grid grid-rows-2 grid-flow-col gap-4">
            <img
              src="/images/website/gallery/img_1.png"
              alt="Gallery 1"
              class="col-span-4 object-cover w-full h-auto"
            />
            <img
              src="/images/website/gallery/img_2.png"
              alt="Gallery 2"
              class="col-span-4 object-cover w-full h-auto"
            />
            <img
              src="/images/website/gallery/img_4.png"
              alt="Gallery 4"
              class="col-span-4 object-cover w-full h-auto"
            />
            <img
              src="/images/website/gallery/img_5.png"
              alt="Gallery 5"
              class="col-span-4 object-cover w-full h-auto"
            />
            <img
              src="/images/website/gallery/img_3.png"
              alt="Gallery 3"
      ...
      <section
        id="hiburan"
        class="w-full relative min-h-[400px] bg-[#16191C] bg-[url('/images/website/hiburan/bg_hiburan.png')] bg-cover"
      >
        <img
          src="/images/website/hiburan/shape_hiburan.png"
          alt="Shape Hiburan"
      ...
      >
        <img
          src="/images/website/promo/bg_promo.png"
        ...
        >
          <div class="relative overflow-hidden">
            ...
            >
              ...
              >
                <img
                  src="/images/website/promo/bg_1.png"
      ...
      >
        <img
          src="/images/website/recent-client/bg_client.png"
          alt="Background"
        ...
        >
          ...
          <div class="relative overflow-hidden">
            ...
            >
              <img
                src="/images/website/recent-client/testimoni_1.png"
                alt="Client 1"
        ...
        <section class="w-full bg-[#1B2023] py-16">
          ...
          >
            <div class="flex flex-col gap-10">
              <img
                src="/images/website/footer/logo.png"
                alt="Logo"
  ...
  <script src="{{ asset('js/scripts/carousel/hero.js') }}"></script>
  <script src="{{ asset('js/scripts/carousel/testimonial.js') }}"></script>
  <script src="{{ asset('js/scripts/carousel/promo.js') }}"></script>
  <script>
