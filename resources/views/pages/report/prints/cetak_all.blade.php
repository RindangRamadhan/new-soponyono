@php $numItems = count($orders);
$i = 0; @endphp
@foreach ($orders as $order)

<table style="width: 100%;  font-family: 'Tahoma, sans-serif';font-size: 10; " cellspacing="0" cellpadding="0">
  <tbody>
    <tr>
      {{-- server --}}
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style=" font-family: 'Tahoma, sans-serif';font-size: 9; text-align:center;vertical-align:middle" colspan="2">
        ...
        --}}
        {{-- local --}}
        <img src="{{ public_path('/images/upload/'.$manager_ulp->tanda_tangan) }}" alt="ttd" width="40" height="40" />
        <br>
