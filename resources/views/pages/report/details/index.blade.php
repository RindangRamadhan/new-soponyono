    ...
    <div class="card-content">
      <div class="card-body card-dashboard">
        <div class="row">
          ...
          <div class="col-sm-3">
            <div class="controls form-label-group position-relative has-icon-left">
              <input type="text" name="date_range" id="date_range" class="form-control pickdaterange"
...
<script>
  ...
  $(document).on('click', '#btnExcel', function (e) {
    ...
    window.open(`/report/detail/export/${up3_id}/${ulp_id}/${start_date}/${end_date}/`);
