    ...
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-content">
          <div class="card-body">
            <form class="form-horizontal form-submit" action="{{ route('petugass.update', $petugas->id) }}" method="POST" novalidate>
              @csrf
              {{ method_field('PATCH') }}
...
<script>
  $(document).ready(function() {
    ...
    $('#uid_id').val(@php echo $petugas->uid_id @endphp).change()
  });
  ...
  $(document).on('change', '#uid_id', function (e) {
    ...
    $.ajax({
      ...
      success: function(response){
        ...
        up3.val(@php echo $petugas->up3_id @endphp).change()
      }
    });
  })
  ...
  $(document).on('change', '#up3_id', function (e) {
    ...
    $.ajax({
      ...
      success: function(response){
        ...
        ulp.val(@php echo $petugas->ulp_id @endphp).change()
      }
    });
  })
</script>
