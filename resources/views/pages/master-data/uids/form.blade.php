  ...
  <div class="col-sm-6">
    <div class="form-group">
      ...
      <div class="controls form-label-group position-relative has-icon-left">
        <input type="text" name="id" class="form-control  @error('id') is-invalid @enderror" placeholder="Kode" required data-validation-required-message="This kode field is required" value="{{isset($uid) ? $uid->id : old('id')}}">
