...
class Helper
{
    ...
    public static function selectServerSide($request, $model, $url, $menu, $customeButton = [], $takeoutButton = [])
    {
        ...
        if (is_string($model)) {
            ...
            $recordsTotal = $model->get()->count();
        }
        $recordsFiltered = $recordsTotal;

        // Sort
        $column = str_replace("__", ".", $request->input('columns')[$request->order[0]['column']]['data']);
    ...
    public static function ResponseWriter($message = '', $data = null, $code = 200)
    {
