...
return [
    'custom' => [
        ...
        'isChat' => false, //If True customizer available or false its not available
        ...
        'isReload' => false, //If True button Reload available or false its not available
        'isCreate' => false, //If True button create available or false its not available
        'isCreateModal' => false, //If True button create available or false its not available
        'isExport' => false, //If True button create available or false its not available
        'isSave' => false, //If True button Update available or false its not available
        'isBack' => false, //If True button Back available or false its not available
        'permission' => [], //If True button Back available or false its not available
    ],
];
